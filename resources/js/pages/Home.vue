  ...
  <AppLayout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          ...
          <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <a href="https://www.wikidata.org/wiki/Wikidata:Main_Page" target="_blank" class="block">
              <img src="/logo-projek/3.png" alt="Wikidata"
                class="w-full h-48 object-contain mb-6 hover:scale-105 transition-transform duration-300">
            </a>
          ...
          <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <a href="https://www.wikifunctions.org/wiki/Wikifunctions:Main_Page" target="_blank" class="block">
              <img src="/logo-projek/1.png" alt="Wikifunctions"
                class="w-full h-48 object-contain mb-6 hover:scale-105 transition-transform duration-300">
            </a>
            <p class="text-gray-600 text-sm leading-relaxed text-center">
          ...
          <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <a href="https://www.mediawiki.org/wiki/MediaWiki" target="_blank" class="block">
              <img src="/logo-projek/2.png" alt="MediaWiki"
                class="w-full h-48 object-contain mb-6 hover:scale-105 transition-transform duration-300">
            </a>
            <p class="text-gray-600 text-sm leading-relaxed text-center">
          ...
          <div class="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <a href="https://wikiba.se/" target="_blank" class="block">
              <img src="/logo-projek/4.png" alt="Wikibase"
                class="w-full h-48 object-contain mb-6 hover:scale-105 transition-transform duration-300">
            </a>
            <p class="text-gray-600 text-sm leading-relaxed text-center">
    ...
    <section class="relative py-16 md:py-24 overflow-hidden">
      <div class="absolute inset-0 grayscale"
        style="background-image: url('/bg/bg-1.jpg'); background-repeat: repeat;">
