...
const navigation = [
  { name: 'Beranda', href: '/' },
  {
    ...
    hasDropdown: true,
    submenu: [
      { name: 'Pengembangan Kapasitas', href: '/pengembangan-kapasitas' },
        ...
        <div class="grid grid-cols-12 gap-8 mb-12">
          ...
          <div class="col-span-12 md:col-span-4">
            ...
            <div class="flex gap-4 mt-6">
              ...
              <a href="https://x.com/wikimediaid"
                class="w-10 h-10 rounded-lg bg-gray-800 hover:bg-gray-700 text-white flex items-center justify-center transition-colors"
              ...
              <a href="https://www.instagram.com/wikimediaid/"
                class="w-10 h-10 rounded-lg bg-gray-800 hover:bg-gray-700 text-white flex items-center justify-center transition-colors"
          ...
          <div class="col-span-6 md:col-span-2">
            ...
            <ul class="space-y-2.5">
              <li>
                <Link href="/pengembang-kapasitas" class="text-gray-700 hover:text-gray-900 transition-colors">
                Pengembang Kapasitas</Link>
              </li>
              <li>
                <Link href="/akademik" class="text-gray-700 hover:text-gray-900 transition-colors">Akademik</Link>
              </li>
              <li>
                <Link href="/kompetisi" class="text-gray-700 hover:text-gray-900 transition-colors">Kompetisi</Link>
              </li>
              <li>
                <Link href="/materi" class="text-gray-700 hover:text-gray-900 transition-colors">Materi</Link>
              </li>
              <li>
          ...
          <!-- Proyek - 2 kolom -->
          <div class="col-span-6 md:col-span-2">
            <h4 class="font-semibold mb-4 text-gray-900">Proyek</h4>
            <ul class="space-y-2.5">
              <li><a href="https://www.wikidata.org/wiki/Wikidata:Main_Page" target="_blank"
                  class="text-gray-700 hover:text-gray-900 transition-colors">Wikidata</a></li>
              <li><a href="https://www.wikifunctions.org/wiki/Wikifunctions:Main_Page" target="_blank"
                  class="text-gray-700 hover:text-gray-900 transition-colors">Wikifunctions</a></li>
              <li><a href="https://www.mediawiki.org/wiki/MediaWiki" target="_blank"
                  class="text-gray-700 hover:text-gray-900 transition-colors">Mediawiki</a></li>
              <li><a href="https://wikiba.se/" target="_blank"
                  class="text-gray-700 hover:text-gray-900 transition-colors">Wikibase</a></li>
            </ul>
          </div>
          ...
          <div class="col-span-12 md:col-span-4">
            ...
            <div class="text-gray-700 space-y-1">
              ...
              <p>Jalan K.H. Mas Mansyur No. 12Karet Tengsin, Tanah Abang</p>
